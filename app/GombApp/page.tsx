...
export default function GombAppHome() {
  ...
  return (
    <>
      ...
      <footer>
        <p className="footer-text">v2.0.2</p>
      </footer>
    </>
  );
}
