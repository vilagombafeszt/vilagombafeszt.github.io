      ...
      <BottomSheetBody>
        <div className="flex w-full flex-col gap-[15px] pt-2.5">
          ...
          <div className="grid w-full grid-cols-3 gap-2.5">
            <button
              type="button"
              className="cursor-pointer rounded-2xl border border-[#a5d6a7] bg-[#e8f5e9] px-2.5 py-3 text-[16px] font-bold text-[#2e7d32] transition-colors hover:bg-[#c8e6c9] active:scale-[0.96]"
            ...
            <button
              type="button"
              className="col-span-3 cursor-pointer rounded-2xl border border-none border-[#a5d6a7] bg-[#2e7d32] bg-[#e8f5e9] px-2.5 py-3 text-[16px] font-bold text-[#2e7d32] text-white transition-colors hover:bg-[#1b5e20] active:scale-[0.96]"
          ...
          {receivedAmount !== '' && (
            <div
              className={`mt-2.5 rounded-2xl border-2 p-3.5 text-center text-[24px] font-bold ${Number(receivedAmount) >= totalPrice ? 'border-[#a5d6a7] bg-[#e8f5e9] text-[#2e7d32]' : 'border-[#ef9a9a] bg-gombapp-pill-danger-bg text-[#c62828]'}`}
            >
